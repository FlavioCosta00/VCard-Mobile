...
class CheckBalanceDashboardStepDef {
	@Given("I have a vCard")
	public void i_have_a_vCard() {
		return;
	}

	@Then("I can see my positive balance")
	public void i_can_see_my_positive_balance() {


		// Replace 'YourTextViewObject' with the actual Test Object identifier representing the mobile text view
		def textViewObject = findTestObject('Object Repository/dashTotalBalance')
	...
	@Then("I can see my banlace is {string}")
	public void i_can_see_my_banlace_is(String string) {
		Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

		Mobile.verifyElementText(findTestObject('Object Repository/dashBalance0'), '0.00 €')
