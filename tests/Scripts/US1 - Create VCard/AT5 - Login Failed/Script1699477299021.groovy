...
CucumberKW.runFeatureFile('Include/features/US1-CreateVCard/AT5-LoginFailed.feature')

/*
Mobile.startApplication('C:\\projetoTaes\\code\\app\\build\\outputs\\apk\\debug\\app-debug.apk', false)

Mobile.setText(findTestObject('null'), '911000002', 0)
...
Mobile.setText(findTestObject('Object Repository/btn-pinCode'), '11', 0)
